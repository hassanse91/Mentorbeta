...
ActiveRecord::Schema.define(version: 20160727004245) do
  ...
  add_index "favorites", ["matiere_id"], name: "index_favorites_on_matiere_id"
  add_index "favorites", ["mentor_id"], name: "index_favorites_on_mentor_id"
