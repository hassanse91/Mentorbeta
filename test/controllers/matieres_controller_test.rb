...
class MatieresControllerTest < ActionController::TestCase
  ...
  test "should create matiere" do
    assert_difference('Matiere.count') do
      post :create, matiere: { mentor_id: @matiere.mentor_id, name: @matiere.name, presentation: @matiere.presentation }
    end
  ...
  test "should update matiere" do
    patch :update, id: @matiere, matiere: { mentor_id: @matiere.mentor_id, name: @matiere.name, presentation: @matiere.presentation }
    assert_redirected_to matiere_path(assigns(:matiere))
  end
