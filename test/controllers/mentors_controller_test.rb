...
class MentorsControllerTest < ActionController::TestCase
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post :create, mentor: { BirthDay: @mentor.BirthDay, FirstName: @mentor.FirstName, LastName: @mentor.LastName, presentation: @mentor.presentation }
    end
  ...
  test "should update mentor" do
    patch :update, id: @mentor, mentor: { BirthDay: @mentor.BirthDay, FirstName: @mentor.FirstName, LastName: @mentor.LastName, presentation: @mentor.presentation }
    assert_redirected_to mentor_path(assigns(:mentor))
  end
